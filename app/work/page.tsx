                ...
                <div className='col-lg-8 mx-lg-auto'>
                  <div className='text-center'>
                    ...
                    <h3 className='ds-3 mt-3 mb-4 text-dark'>
                      Explore{' '}
                      <span className='text-300'>My Latest Work and Discover the</span>{' '}
                      Craftsmanship Behind <span className='text-300'>Each Design</span>
                    </h3>
                    <p className='text-300 fs-5'>
                      Explore my latest work and discover the craftsmanship behind each
                      design: <br />a detailed look into how I bring innovation and
                      creativity to life
                    </p>
                  </div>
                </div>
                      ...
                      <div className='card__inner bg-6 p-lg-6 p-md-4 p-3'>
                        ...
                        <div className='card__content px-md-4 px-3'>
                          ...
                          <p className='text-300 mb-lg-auto mb-md-4 mb-3'>
                            Designed an interactive and engaging educational platform
                            aimed at improving online learning experiences. This included
                            developing intuitive navigation, interactive course materials,
                            and features that support student engagement and
                            participation, making learning more accessible and enjoyable.
                          </p>
                          <div className='d-md-flex content'>
                            <p className='mb-0 fs-7 text-dark text-uppercase w-40'>
                              Client
