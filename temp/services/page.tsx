                ...
                <div className='col-lg-8 mx-lg-auto'>
                  <div className='text-center'>
                    ...
                    <p className='text-300 fs-5'>
                      With expertise in mobile app and web design, I transform ideas into
                      visually <br />
                      stunning and user-friendly interfaces that captivate and retain
                      users. <br />
                          ...
                          <div className='card__content mt-lg-5 mt-md-4 mt-3 pb-4'>
                            <div className='d-md-flex content'>
                              ...
                              <p className='card__description text-300 fs-6 mb-0'>
                                Conducting thorough user research through surveys,
                                interviews, and usability studies to understand target
                                audiences and their needs, ensuring designs are
                            ...
                            <div className='d-md-flex content'>
                              ...
                              <p className='card__description text-300 fs-6 mb-0'>
                                Designing detailed wireframes and interactive prototypes
                                to visualize and test user flows and interactions,
                                allowing for early feedback and iterative improvements.
                              </p>
                            </div>
                            <div className='d-md-flex content'>
                              <p className='fs-7 text-dark text-uppercase w-md-40 pe-8 mb-2 d-inline-block'>
                              ...
                              <p className='card__description text-300 fs-6 mb-0'>
                                Implementing comprehensive user testing sessions to gather
                                feedback, identify pain points, and make data-driven
                                design improvements, ensuring a seamless user experience.
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className='card__inner bg-6 px-md-5 py-md-6 px-3 py-4'>
                          ...
                          <div className='card__content mt-lg-5 mt-md-4 mt-3 pb-4'>
                            <div className='d-md-flex content'>
                              ...
                              <p className='card__description text-300 fs-6 mb-0'>
                                Creating designs that work smoothly on both iOS and
                                Android platforms, ensuring a consistent and high-quality
                            ...
                            <div className='d-md-flex content'>
                              ...
                              <p className='card__description text-300 fs-6 mb-0'>
                                Developing interactive prototypes to demonstrate app
                                functionality allowing stakeholders to experience the app
                            ...
                            <div className='d-md-flex content'>
                              ...
                              <p className='card__description text-300 fs-6 mb-0'>
                                Ensuring the app design is consistent with your brand’s
                                identity and aesthetics, maintaining brand recognition and
                        ...
                        <div className='card__inner bg-6 px-md-5 py-md-6 px-3 py-4'>
                          ...
                          <div className='card__content mt-lg-5 mt-md-4 mt-3 pb-4'>
                            <div className='d-md-flex content'>
                              ...
                              <p className='card__description text-300 fs-6 mb-0'>
                                Creating memorable and impactful logos that represent your
                                brand’s essence and values, helping you stand out in a
                                crowded marketplace.
                              </p>
                            </div>
                            <div className='d-md-flex content'>
                              ...
                              <p className='card__description text-300 fs-6 mb-0'>
                                Developing comprehensive brand guidelines that include
                                typography, color visual styles to maintain consistency
                            ...
                            <div className='d-md-flex content'>
                              ...
                              <p className='card__description text-300 fs-6 mb-0'>
                                Designing a variety of visual assets, including business
                                cards, letterheads, to ensure all brand communications are
                        ...
                        <div className='card__inner bg-6 px-md-5 py-md-6 px-3 py-4'>
                          ...
                          <div className='card__content mt-lg-5 mt-md-4 mt-3 pb-4'>
                            <div className='d-md-flex content'>
                              ...
                              <p className='card__description text-300 fs-6 mb-0'>
                                Utilizing modern technologies like HTML, CSS, and
                                JavaScript to create responsive and interactive web pages
                            ...
                            <div className='d-md-flex content'>
                              ...
                              <p className='card__description text-300 fs-6 mb-0'>
                                ...
                                with technologies such as Node.js, Python, or Ruby on
                                Rails to ensure seamless performance and data integrity.
                              </p>
                            </div>
                            <div className='d-md-flex content'>
                              <p className='fs-7 text-dark text-uppercase w-md-40 pe-8 mb-2 d-inline-block'>
                              ...
                              <p className='card__description text-300 fs-6 mb-0'>
                                Integrating user-friendly CMS platforms like WordPress,
                                Drupal, or custom solutions for easy content updates,
                                allowing non-technical users to manage website content
                                efficiently.
                              </p>
                            </div>
                          </div>
                ...
                <div className='row align-items-center justify-content-between'>
                    ...
                    <div className='counter-item-cover counter-item'>
                      <div className='content text-center mx-auto d-flex align-items-center'>
                        <span className='ds-3 count text-primary-1 fw-medium my-0'>
                          +<span className='odometer ds-1 text-dark fw-semibold'>10</span>
                        </span>
                  ...
                  <div className='col-lg-auto col-md-6'>
                    <div className='counter-item-cover counter-item'>
                      <div className='content text-center mx-auto d-flex align-items-center'>
                        <span className='ds-3 count text-primary-1 fw-medium my-0'>
                          +<span className='odometer ds-1 text-dark fw-semibold'>35</span>
                        </span>
                        <div className='text-start ms-2'>
          ...
          >
            <div className='container position-relative z-1'>
              ...
              <span className='fs-5 fw-medium text-200'>
                ...
                minds. If you
                <br />
                have a project in mind or just want to chat about design, feel free to
                reach out!
              </span>
                ...
                <div className='col-lg-4 d-flex flex-column'>
                  ...
                  <div className='d-flex align-items-center mb-4 position-relative d-inline-flex'>
                    ...
                    <div className='ps-3'>
                      ...
                      <h6 className='mb-0'>contact@eduardo.dev</h6>
                    </div>
                    <Link
